...
type cGithubGatsbyBlogsrccomponentssearchBoxTsx1318453225QueryVariables = Exact<{ [key: string]: never; }>;


type cGithubGatsbyBlogsrccomponentssearchBoxTsx1318453225Query = { readonly allKeywordSearchJson: { readonly edges: ReadonlyArray<{ readonly node: Pick<KeywordSearchJson, 'keywords' | 'slug' | 'title'> }> } };
