...
type cGithubGatsbyBlogsrccomponentskeywordSearchJsx2003985847QueryVariables = Exact<{ [key: string]: never; }>;


type cGithubGatsbyBlogsrccomponentskeywordSearchJsx2003985847Query = { readonly allKeywordSearchJson: { readonly edges: ReadonlyArray<{ readonly node: Pick<KeywordSearchJson, 'keywords' | 'slug' | 'title'> }> } };
