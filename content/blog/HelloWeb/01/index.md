...
この講座でHTMLとCSSを学び、サンプルのWebサイトを作成するのが目標です。サンプルページは現在作成中ですが、トップページ＋ブログ記事ページの構成になっています。
...
OSは**Windows10**を想定します。これは、私がWindows10を使って動作検証をしているためです。しかし、HTMLとCSSを学習するという内容的に、Windows8やWindows11を使用したとしても支障なく読み進められるはずです。
...
もちろん他のエディターでも支障のない内容になっていますが、VSCodeを使用していることを前提とした説明をすることがあります。また、VSCodeのプラグインもちょくちょく紹介します。
