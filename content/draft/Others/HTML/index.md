...
HTMLの各要素を仕様に沿って解説する本です。サンプルWebサイトを作るというようなことはこの本ではしません。よって、完全なHTML初心者向けの本ではありません。CSSの話なんてほとんど出てこないので、「HTMLとCSSを覚えてWebサイトを作れるようになりたい」という人向けの本ではないでしょう（武器になるHTMLは、最終章でサンプルページを作ることになりますが、これまで説明してきた要素の振り返りや実践という意味合いだと思われます。ともかく、サンプルページを作ってみることがゴールの本ではないでしょう）。

特に、「HTML解体新書」の方は、ある程度しかHTMLを触った経験がない人、セマンティックやアクセシビリティという言葉を知らない人が読んでも、知識の羅列を咀嚼することはできないと感じました（すぐに眠くなるでしょう）。「2冊目に読むといい」と言った紹介文もどこかで見ましたが、2冊目でも難しいのではと個人的には思います。
